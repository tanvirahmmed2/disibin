      ...
      <div className='container-custom'>
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20'>
          ...
          <div className='space-y-8'>
            <Link href="/" className='text-3xl font-black tracking-tighter'>Disibin<span className='text-emerald-500'>.</span></Link>
            ...
            <div className='flex items-center gap-4'>
                <Link href="https://www.facebook.com/disibin" className='w-10 h-10 rounded-xl bg-slate-800 flex items-center justify-center hover:bg-emerald-600 transition-all'><FaFacebook /></Link>
                <Link href="https://www.instagram.com/user.disibin/" className='w-10 h-10 rounded-xl bg-slate-800 flex items-center justify-center hover:bg-emerald-600 transition-all'><FaInstagram /></Link>
                <Link href="https://t.me/disibin" className='w-10 h-10 rounded-xl bg-slate-800 flex items-center justify-center hover:bg-emerald-600 transition-all'><FaTelegram /></Link>
            </div>
          </div>

          <div className='space-y-8'>
            <h4 className='text-[10px] font-black uppercase tracking-widest text-emerald-500'>Core Navigation</h4>
          ...
          <div className='space-y-8'>
            <h4 className='text-[10px] font-black uppercase tracking-widest text-emerald-500'>Information</h4>
            <div className='flex flex-col gap-4 text-sm font-bold text-slate-300'>
          ...
          <div className='space-y-8'>
            <h4 className='text-[10px] font-black uppercase tracking-widest text-emerald-500'>HQ & Contact</h4>
            <div className='text-sm font-bold text-slate-300 space-y-4 leading-relaxed'>
                <p>Rahmatpur, Sadar<br/>Mymensingh - 2200, BD</p>
                <p className='text-emerald-500'>+880 1805 003886</p>
        ...
        <div className='pt-12 border-t border-slate-800 flex flex-col md:flex-row items-center justify-between gap-6'>
            ...
            <div className='flex items-center gap-8 text-slate-500 text-[10px] font-black uppercase tracking-widest'>
                ...
                <Link href='/' className='hover:text-emerald-500 transition-colors'>API Docs</Link>
            </div>
        </div>
      </div>
    </footer>
