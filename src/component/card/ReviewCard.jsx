...
const ReviewCard = ({ review }) => {
    return (
        <div className='w-full flex flex-col items-center gap-2 p-2 rounded-2xl shadow hover:shadow-lg transform ease-in-out duration-500 shadow-primary/20 text-center cursor-pointer'>
