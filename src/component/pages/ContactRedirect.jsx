...
const ContactRedirect = () => {
    return (
        <div className='w-full flex flex-col items-center justify-center gap-4 text-center p-4'>
            <motion.div  initial={{opacity:0, y:50}} whileInView={{opacity:1, y:0}} transition={{duration:0.6}} className='w-auto mx-auto gap-4 bg-black rounded-2xl p-4 flex flex-col items-center justify-center'>
