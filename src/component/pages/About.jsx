...
const About = () => {
  return (
    <section className="w-full py-20 my-4 rounded-[2.5rem] overflow-hidden relative">
      ...
      >
        ...
        {/* Vision statement */}
        <p className="text-xl sm:text-2xl md:text-3xl lg:text-4xl text-center font-poppins text-slate-800 leading-relaxed max-w-4xl">
          To deliver{' '}
