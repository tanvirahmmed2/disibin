            ...
            <div className='container-custom grid grid-cols-1 lg:grid-cols-2 gap-20 items-center'>
                <div className='space-y-8'>
                    <div className='space-y-4'>
                        <h3 className='text-[10px] font-black uppercase tracking-[0.3em] text-emerald-500'>Our Philosophy</h3>
                ...
                <div className='grid grid-cols-2 gap-6'>
                    {stats.map((stat, idx) => (
                        <motion.div 
                            ...
                            viewport={{ once: true }}
                            className='p-10 bg-slate-50/50 border border-slate-100 rounded-[2.5rem] flex flex-col items-center text-center space-y-4 hover:border-emerald-500/10 transition-all group'
                        >
