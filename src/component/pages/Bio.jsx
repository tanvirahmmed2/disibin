        ...
        <div className='w-full  flex  items-center justify-center p-4 py-8'>
            <div className='w-full  flex flex-col items-center justify-center gap-6'>
                ...
                <div className='w-full text-center grid grid-cols-2 md:grid-cols-4 gap-2'>
                    <motion.div initial={{ scale: 0.9, opacity: 0 }} whileInView={{ scale: 1, opacity: 1 }} transition={{ duration: 0.5 }} className='w-full flex flex-col items-center justify-center  border border-teal-500 border-opacity-20 h-37.5 rounded-lg text-xl font-semibold cursor-pointer hover:-mt-2 ease-in-out duration-300 hover:shadow-xl transform'>
                        <p>150+</p>
