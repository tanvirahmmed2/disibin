        ...
        <section className='w-full py-24 bg-white'>
            <div className='container-custom grid grid-cols-1 lg:grid-cols-2 gap-16 items-center'>
                <div className='space-y-8'>
                    ...
                    <div className='pt-4'>
                         <button className='px-8 py-4 bg-slate-50 text-slate-900 font-semibold uppercase tracking-widest text-[10px] rounded-xl hover:bg-slate-100 transition-all active:scale-95'>
                            Learn Our Method
                         </button>
                    </div>
                </div>
