    ...
    return (
        ...
        >
            ...
            <div className='w-full flex flex-row items-center justify-between mt-2'>
                <Link className='text-sm font-bold text-slate-500 hover:text-emerald-500 transition-colors' href={'/recover'}>Forgot password?</Link>
                <Link className='text-sm font-bold text-emerald-500 hover:text-emerald-500-dark transition-colors' href={'/login'}>Already registered?</Link>
            </div>

            <button 
                type='submit' 
                disabled={isLoading}
                className='w-full mt-4 py-4 bg-emerald-500 text-white rounded-xl font-bold flex items-center justify-center gap-2 hover:bg-emerald-500-dark hover:shadow-lg hover:shadow-primary/10 transition-all active:scale-[0.98] disabled:opacity-70 disabled:pointer-events-none'
            >
                {isLoading ? (
