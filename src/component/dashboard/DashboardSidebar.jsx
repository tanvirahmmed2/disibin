...
const DashboardSidebar = () => {
  const { dashboardSidebar, setDashboardSidebar, userData } = useContext(Context)
  ...
  const links = {
    admin: [
      ...
      { name: 'People', href: '/dashboard/admin/people', icon: <FiUsers /> },
    ...
    support: [
      { name: 'Support Inbox', href: '/dashboard/support/support', icon: <FiMessageSquare /> },
