        ...
        <header className="h-20 bg-white/80 backdrop-blur-md border-b border-slate-100 flex items-center justify-between px-8 sticky top-0 z-40 transition-all duration-300">
            <div className="flex items-center gap-6">
                <button 
                    ...
                    className="p-2.5 bg-slate-50 hover:bg-primary/5 text-slate-500 hover:text-primary rounded-xl transition-colors"
                >
            ...
            <div className="flex items-center gap-4">
                ...
                <div className="flex items-center gap-4 pl-2 cursor-pointer group">
                    <div className="text-right hidden sm:block">
                        <div className="text-sm font-bold text-slate-800 leading-tight group-hover:text-primary transition-colors">
                            {userData?.name || 'User'}
                        </div>
                    ...
                    <div className="w-11 h-11 rounded-[1.125rem] bg-slate-50 border border-slate-100 flex items-center justify-center overflow-hidden shadow-sm group-hover:shadow-md group-hover:shadow-primary/20 group-hover:border-primary/20 transition-all">
                        {userData?.image ? (
                            ...
                            <span className="text-primary font-black text-lg">{userData?.name?.charAt(0) || 'U'}</span>
                        )}
                    </div>
                </div>
            </div>
