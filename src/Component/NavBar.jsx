...
export default function NavBar(props) {
    ...
    return (
        <nav className=' bg-gray-50 shadow-xl  h-12  w-full z-999 fixed '>
            <motion.div style={{ scaleX: scrollYProgress }} className='origin-left absolute bg-white w-full h-12 -z-20'></motion.div>
