    ...
    return (
        ...
        <div className='flex flex-col items-center gap-8 justify-center w-full min-h-[95vh] px-4 py-8 pt-20'>
            ...
            <div className='grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-12 text-black'>
                <div className='flex flex-col gap-4 items-center justify-center w-[250px] h-[300px] bg-teal-500 group hover:bg-teal-300 hover:shadow-2xl hover:scale-110  cursor-pointer px-2 py-2 rounded-xl relative'>
