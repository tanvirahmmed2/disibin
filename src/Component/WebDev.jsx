...
export default function WebDev(props) {
    return (
        ...
        <div className='flex flex-col items-center gap-8 justify-center w-full min-h-[95vh] px-4 py-2 pt-20'>
            ...
            <div className='grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-12 text-teal-700'>
                <div className='flex flex-col gap-4 items-center justify-center w-[250px] h-[300px] bg-teal-100 group hover:bg-teal-200 hover:shadow-2xl hover:scale-110  cursor-pointer px-2 py-2 rounded-xl relative'>
                ...
                <div className='flex flex-col gap-4 items-center justify-center w-[250px] h-[300px] bg-teal-100 group hover:bg-teal-200 hover:shadow-2xl hover:scale-110 cursor-pointer px-2 py-2 rounded-xl relative'>
                    ...
                    <Link to="/web-app" className='absolute bottom-3 font-semibold text-sm hidden group-hover:block'>Read More</Link>
                </div>
                <div className='flex flex-col gap-4 items-center justify-center w-[250px] h-[300px] bg-teal-100 group hover:bg-teal-200 hover:shadow-2xl hover:scale-110 cursor-pointer px-2 py-2 rounded-xl relative'>
