...
const Intro = () => {
  return (
    <section className="w-full mt-48 lg:mt-0 min-h-screen h-auto p-4">
      <div className="w-full h-screen flex flex-col lg:flex-row items-center justify-center gap-16 lg:gap-2">
        ...
        <div className="w-full rounded-2xl gap-2 m-4 flex flex-col items-center justify-center  shadow-sm shadow-indigo-500 p-4 border-2 border-red-500 border-opacity-20">
