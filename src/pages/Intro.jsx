        ...
        <div className="w-full flex flex-col p-4 items-start justify-center gap-3 text-lg">
          ...
          <div className="w-full flex flex-row items-center justify-start gap-4">
            <div className={`flex w-32  mt-2 flex-col  group relative group/item2  hover:bg-transparent transition-all duration-500 ease-out origin-left rounded-lg`}>
              <span className='absolute border-2 border-indigo-500 inset-0 bg-indigo-500 w-0 group-hover/item2:w-full transition-all duration-500 ease-out origin-left rounded-lg shadow-lg shadow-indigo-600'></span>
          ...
          <div className='w-auto h-auto flex flex-row items-center justify-center gap-4'>
            <a className='px-2 p-2 bg-white/20 rounded-lg hover:scale-125 transition duration-500 hover:text-indigo-500' href="https://www.facebook.com/disibin"><FaFacebook /></a>
            <a className='px-2 p-2 bg-white/20 rounded-lg hover:scale-125 transition duration-500 hover:text-indigo-500' href="https://www.instagram.com/user.disibin/"><FaInstagram /></a>
            <a className='px-2 p-2 bg-white/20 rounded-lg hover:scale-125 transition duration-500 hover:text-indigo-500' href="https://www.youtube.com/@Disibin"><FaYoutube /></a>
            <a className='px-2 p-2 bg-white/20 rounded-lg hover:scale-125 transition duration-500 hover:text-indigo-500' href="mailto:disibin@gmail.com"><CiMail /></a>
            <a className='px-2 p-2 bg-white/20 rounded-lg hover:scale-125 transition duration-500 hover:text-indigo-500' href="tel:+8801987131369"><FaPhone /></a>
            <a className='px-2 p-2 bg-white/20 rounded-lg hover:scale-125 transition duration-500 hover:text-indigo-500' href="https://t.me/disibin"><FaTelegram /></a>
