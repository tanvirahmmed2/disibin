...
const Sidebar = () => {
    ...
    return (
    <section className={`w-[250px] h-screen flex flex-col items-center justify-around py- 16 ${sidebar? 'translate-x-0': '-translate-x-full'} transform transition-transform duration-500 ease-in-out fixed top-0 left-0 backdrop-blur-2xl z-50`}>
