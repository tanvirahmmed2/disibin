  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[70vh] py-24 px-6 text-center">
      <div className="w-full max-w-3xl">
        <h4 className="text-[10px] font-bold uppercase tracking-[0.4em] text-primary mb-6">Build the Future</h4>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
           <button className="px-10 py-5 rounded-2xl bg-slate-900 text-white font-bold hover:bg-primary transition-all shadow-xl shadow-slate-900/10">View Open Positions</button>
