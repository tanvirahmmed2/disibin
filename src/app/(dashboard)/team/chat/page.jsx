              ...
              {selectedMemberIds.length > 1 && (
                <div className="pt-2 border-t border-slate-100">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xs text-slate-800 focus:outline-none focus:ring-2 focus:ring-sky-500 transition-all"
                  />
                </div>
              )}
            </div>
