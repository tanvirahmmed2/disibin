...
const InternalMail = () => {
    ...
    const sendMessage = async () => {
        ...
        try {
            ...
            setInputText('')
            // Optionally refresh chats to update last message preview
            fetchChats()
        } catch (error) {
        ...
        <div className="h-[calc(100vh-160px)] flex gap-6">
            ...
            <div className="w-80 bg-white rounded-[2.5rem] border border-slate-50 shadow-sm flex flex-col p-4">
                <div className="flex items-center gap-2 px-3 py-2 bg-slate-50 rounded-xl border border-slate-100 text-slate-400 mb-6">
                    ...
                    <input type="text" placeholder="Search conversations..." className="bg-transparent border-none outline-none text-xs w-full" />
                </div>
