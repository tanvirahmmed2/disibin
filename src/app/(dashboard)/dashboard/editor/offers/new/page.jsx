            ...
            <form onSubmit={handleSubmit} className="bg-white p-12 rounded-[3rem] border border-slate-50 shadow-sm space-y-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="space-y-2">
                        ...
                        <input 
                            ...
                            className="w-full h-16 px-6 rounded-2xl bg-slate-50 border-none focus:ring-2 focus:ring-primary transition-all font-bold text-slate-700"
                            placeholder="e.g. Early Bird Digital Transformation"
                        />
                    </div>
                    <div className="space-y-2">
                        <label className="text-sm font-bold text-slate-700 ml-1">Slug (URL friendly)</label>
                        <input 
                            type="text" name="slug" required value={formData.slug} onChange={handleChange}
                            className="w-full h-16 px-6 rounded-2xl bg-slate-50 border-none focus:ring-2 focus:ring-primary transition-all font-bold text-slate-700"
                            placeholder="e.g. early-bird-digital"
                        />
                    </div>
                </div>
                ...
                <div className="space-y-2">
                    ...
                    <textarea 
                        ...
                        className="w-full h-32 px-6 py-4 rounded-2xl bg-slate-50 border-none focus:ring-2 focus:ring-primary transition-all font-bold text-slate-700"
                        placeholder="Detail what this offer includes..."
                    />
                </div>
                ...
                <div className="space-y-2">
                    ...
                    <textarea 
                        ...
                        className="w-full h-48 px-6 py-4 rounded-2xl bg-slate-50 border-none focus:ring-2 focus:ring-primary transition-all font-bold text-slate-700"
